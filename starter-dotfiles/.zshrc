...
#    user_symbol = "#"
#fi
#POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{green}$user_symbol %f "
#POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir kubecontext pyenv vcs)
...
#alias pulsar-perf="kubectl -n pulsar exec $(kubectl -n pulsar get pod -l component=bastion  -o jsonpath='{.items[0].metadata.name}') -it -- bin/pulsar-perf"
